...
func TestCustomer(t *testing.T) {
	...
	customer.rentals = append(customer.rentals, NewRental(NewM("Kingsman", CreateRegular()), 2))
	customer.rentals = append(customer.rentals, NewRental(NewM("Iron Man", CreateRegular()), 3))
